...
function App() {
    ...
    const handleRunAiAnalysis = async (record) => {
        ...
        const promptLines = [
            ...
            "    ・水深の扱い（最重要）：水深データに「40〜60m」などの幅表記がある場合、「水深40〜60mからスタートしました」のように開始地点として幅表記を連結することは物理的におかしいため絶対に禁止です。スタート文はポイント名のみとするか、幅表記に触れる場合は「日中は40〜60mラインを幅広く攻め…」のようにその後の展開として表現してください。",
