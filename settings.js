        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-3 animate-[fadeIn_0.15s_ease-out]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 w-full max-w-md max-h-[92dvh] flex flex-col overflow-hidden text-gray-800 dark:text-slate-100">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 text-sm sm:text-base no-scrollbar bg-white dark:bg-slate-800">
                    ...
                    {/* ========================================== */}
                    {/* ========================================== */}
                    {/* タブ 1: 基本設定（境界枠くっきり＆目に優しい調整版） */}
                    {/* ========================================== */}
                    {activeSettingsTab === 'basic' && (
                        <div className="space-y-4 animate-[fadeIn_0.15s_ease-out]">
                            {/* 画面テーマ切り替えスイッチ */}
                            <div className="flex justify-between items-center p-3 bg-amber-50/70 dark:bg-slate-900/60 rounded-xl border border-amber-200/80 dark:border-slate-700/80 shadow-2xs">
                                <div>
                                ...
                                <button
                                    ...
                                    className="px-3.5 py-1.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-slate-200 rounded-lg font-black text-sm shadow-2xs active:scale-95 transition-all flex items-center gap-1"
                                >
                            ...
                            {/* 釣り座席数設定 */}
                            <div className="bg-emerald-50/60 dark:bg-slate-900/60 p-3 rounded-xl border border-emerald-200/80 dark:border-slate-700/80 space-y-2 shadow-2xs">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-gray-200 dark:border-slate-700 rounded-lg px-2.5 py-2 font-black bg-white dark:bg-slate-800 text-gray-800 dark:text-slate-100 text-center text-lg focus:outline-none focus:ring-1 focus:ring-sky-400"
                                            value={portCount}
                            ...
                            {/* 基本海況・ポイント */}
                            <div className="bg-sky-50/80 dark:bg-slate-900/60 p-3 rounded-xl border border-sky-200/80 dark:border-slate-700/80 space-y-2.5 shadow-2xs">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2 font-black text-sm bg-white dark:bg-slate-800 text-gray-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-sky-400"
                                        value={targetFish}
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            list="point-options"
                                            className="w-full border border-gray-200 dark:border-slate-700 rounded-lg px-2.5 py-2 font-bold text-sm bg-white dark:bg-slate-800 text-gray-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-sky-400"
                                            value={point}
